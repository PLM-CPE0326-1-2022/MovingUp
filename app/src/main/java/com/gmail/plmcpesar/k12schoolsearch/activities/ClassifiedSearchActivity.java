...
public class ClassifiedSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout searchframe = (LinearLayout) findViewById(R.id.search_frame);
        searchframe.setBackgroundResource(R.drawable.searchinitialbg);
        ...
        edtx.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH){
                    LinearLayout searchframe = (LinearLayout) findViewById(R.id.search_frame);
                    searchframe.setBackgroundResource(R.color.colorWhite);
    ...
    private void DisplaySchoolList(String searchparam, String searchelement) {
        Toast.makeText(ClassifiedSearchActivity.this, "Started Search", Toast.LENGTH_LONG).show();
