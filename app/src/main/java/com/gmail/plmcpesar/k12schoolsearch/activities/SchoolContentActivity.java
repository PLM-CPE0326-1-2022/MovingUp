...
public class SchoolContentActivity extends AppCompatActivity {

    private String DisplayKey;
    private ImageView ContentSchoolImage;
    private CircleImageView ContentSchoolLogo;
    private TextView ContentSchoolName;
    private TextView ContentSchoolType;
    private TextView ContentSchoolLocation;
    private RecyclerView schoolContentSearchrview;
    private DatabaseReference ContentReference;
    private DatabaseReference SchoolContentSearchRef;
